...
function winImg() {
  ...
  /* Gamiing Sites don't like reload() */
  function restart() {
    start();
...
let randy = ["Fizzling","Quiz","Quinsy","Jives","Babbling","Bopped","Swizz","Shagginess","Zigzagging","Buzz","Klutz","Ivory","Banjo","Azure","Blizzard","Baffles","Buffoon","Daiquiri","Queue","Groggy","Vortex","Voodoo","Schnapps","Schizophrenia","Zephyr","Spritz","Thriftless","Thumbscrew","Squawk","Voyeurism","Vaporize","Zodiac","Rhubarb","Transgress","Rickshaw","Snazzy","Quixotic","Knapsack","Jinx","Affix","Miser","Index","Defang","Bludgeon","Blurt","Bridge","Coffin","Cruicible","Damper","Pontiff","Gander","Harpy","Harvest","Panic","Manic","Dizzy","Pragmatic","Dragon","Vivify","Philanthropy","Append","Gastric","Major","Dogrel","Convene","Rhubric","Dozing","Bowing","Rowing","Posing","Manic","Extend","Graphic","Gripping","Exult","Comfort","Valour","Vexing","Vomit","Grapeshot","Leaden","Bowels","Pantomine","Parish","Garish","Pollux","Griffin","Bullock","Maggot","Strand","Sling","Confound","Flagon","Victor","Hansom","Flange","Capstone","Frizzy","Spangled","Murky","Tangle","Jabber","Rankle","Dirge","Grommet","Cravet","Blitz","Ghostly","Expand","Conical","Harmonica","Found","Bound","Sound","Wound","Pound","Round","Mound","Tarmac","Govern","Gound","Court","Count","Adjure","Implode","Devote","Demote","Denote"];
